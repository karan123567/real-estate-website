...
export const propertyAPI = {
  ...
  getById: (id) => apiFetch(`/api/properties/${id}`),
  getFeatured: () => apiFetch('/api/properties/featured'),
};

// Admin APIs
export const adminAPI = {
  login: (data) => apiFetch('/api/admin/login', {
    method: 'POST',
    body: JSON.stringify(data)
  }),
...
// Inquiry API
export const inquiryAPI = {
  submit: (data) => apiFetch('/api/inquiries', {
    method: 'POST',
    body: JSON.stringify(data)
  }),
};
