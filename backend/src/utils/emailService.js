...
const sendInquiryEmails = async (inquiry) => {
  ...
  try {
    // Get property title (handle both formats)
    const propertyTitle = inquiry.propertyTitle || inquiry.property_title || 'General Inquiry';
          ...
          <div style="background: #f8f9fa; padding: 20px; border-radius: 0 0 8px 8px; border: 1px solid #e0e0e0;">
            <table style="width: 100%; border-collapse: collapse;">
              <tr><td style="padding: 8px; font-weight: bold; width: 30%;">Property:</td>
                  <td style="padding: 8px;">${propertyTitle}</td></tr>
            ...
            <div style="margin-top: 20px; text-align: center;">
              <a href="${process.env.FRONTEND_URL}/admin/inquiries" 
                 style="background: #C9A96E; color: white; padding: 12px 24px; border-radius: 4px; text-decoration: none; display: inline-block;">
                View in Admin Panel
              </a>
            </div>
            ` : ''}
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="padding: 30px; background: white; border: 1px solid #e0e0e0; border-radius: 0 0 8px 8px;">
            ...
            <p>We received your inquiry${propertyTitle !== 'General Inquiry' ? ` about <strong>${propertyTitle}</strong>` : ''}.</p>
